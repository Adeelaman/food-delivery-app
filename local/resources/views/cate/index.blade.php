...
@section('title') @lang('app.storeCat') @endsection
...
<div class="card-body"><h4 class="card-title">@lang('app.storeCat')<a href="{{ Asset($link.'add') }}" class="btn btn-primary" style="float: right">@lang('app.add_new')</a></h4> </div>
...
<td width="15%"><img src="{{ Asset('upload/cate/'.$row->img) }}" height="60px"></td>
