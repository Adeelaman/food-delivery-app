...
@section('title') @lang('app.add_category') @endsection
...
<div class="card-body"><h4 class="card-title">@lang('app.add_category') <a href="{{ Asset($link.'add') }}" class="btn btn-primary" style="float: right">@lang('app.add_new')</a></h4> </div>
<div class="table-responsive">
<table class="table mb-0">
<thead >
<tr>
<th>@lang('app.sort_no')</th>
<th>@lang('app.name')</th>
