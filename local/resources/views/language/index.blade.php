...
@section('title') @lang('app.app_lang') @endsection
...
<div class="card-body"><h4 class="card-title">@lang('app.app_lang') <a href="{{ Asset($link.'add') }}" class="btn btn-primary" style="float: right">@lang('app.add_new')</a></h4> </div>
<div class="table-responsive">
<table class="table mb-0">
<thead >
<tr>
<th>@lang('app.icon')</th>
<th>@lang('app.lang_title')</th>
<th>@lang('app.type')</th>
...
@foreach($data as $row)
<tr>
<td width="20%"><img src="{{ Asset('upload/language/'.$row->icon) }}" width="50px"></td>
<td width="20%">{{ $row->name }}</td>
<td width="20%">@if($row->type == 0) LTR @else RTL @endif</td>
<td width="20%">
