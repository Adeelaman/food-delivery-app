...
<div class="form-group col-md-6">
<label for="inputEmail6">Background Color Code (e.g #f3f3f3)</label>
<?php echo Form::color('color',null,['id' => 'code','class' => 'form-control','required']); ?>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/cate/form.blade.php ENDPATH**/ ?>