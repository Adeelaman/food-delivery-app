...
<?php echo Form::text('l_tax[]',$data->getSData($data->s_data,$l->id,2),['id' => 'code','class' => 'form-control']); ?>
...
<option value="0" <?php if($data->veg_nonveg == 0): ?> selected <?php endif; ?>>Yes</option>
<option value="1" <?php if($data->veg_nonveg == 1): ?> selected <?php endif; ?>>No</option>
</select>
</fieldset>
</div>
...
<option value="0" <?php if($data->delivery == 0): ?> selected <?php endif; ?>>Yes</option>
<option value="1" <?php if($data->delivery == 1): ?> selected <?php endif; ?>>No</option>
</select>
</div>
...
<option value="0" <?php if($data->dinein == 0): ?> selected <?php endif; ?>>Yes</option>
<option value="1" <?php if($data->dinein == 1): ?> selected <?php endif; ?>>No</option>
</select>
</div>
...
<input type="text" name="tax_name" class="form-control" value="<?php echo e($data->tax_name); ?>">
</fieldset>
</div>
...
<input type="text" name="tax_value" class="form-control" value="<?php echo e($data->tax_value); ?>">
</fieldset>
</div>
...
<?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

<div class="col-md-2"><img src="<?php echo e(Asset('upload/store/menu/'.$img->file)); ?>" height="60px"><br>

<?php if(isset($hasStore)): ?>

<a href="<?php echo e(Asset(env('store').'/removeImage?type=menu&id='.$img->id)); ?>" onclick="return confirm('Are you sure?')" style="color:red">Remove</a>

<?php else: ?>

<a href="<?php echo e(Asset('removeImage?type=menu&id='.$img->id)); ?>" onclick="return confirm('Are you sure?')" style="color:red">Remove</a>
...
</style><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/store/form.blade.php ENDPATH**/ ?>