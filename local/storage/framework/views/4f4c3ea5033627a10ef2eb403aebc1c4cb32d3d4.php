...
function calTotal()
{
    ...
    document.getElementById("total").innerHTML = "<?php echo e($c); ?>"+sum;
  ...
  let total       = sum;
    ...
    document.getElementById("grand").innerHTML = "<?php echo e($c); ?>"+total;
...
</style><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/saas_pos/local/resources/views/store_end/order/js.blade.php ENDPATH**/ ?>