<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('app.storeCat'); ?> <?php $__env->stopSection(); ?>
...
<div class="card-body"><h4 class="card-title"><?php echo app('translator')->get('app.storeCat'); ?><a href="<?php echo e(Asset($link.'add')); ?>" class="btn btn-primary" style="float: right"><?php echo app('translator')->get('app.add_new'); ?></a></h4> </div>
...
<td width="15%"><img src="<?php echo e(Asset('upload/cate/'.$row->img)); ?>" height="60px"></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/saas_pos/local/resources/views/cate/index.blade.php ENDPATH**/ ?>