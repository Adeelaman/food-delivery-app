...
<div class="form-group col-md-4">
<label for="inputEmail6">Login Button</label>
<input type="text" name="login_btn[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'login_btn')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Signup Button</label>
<input type="text" name="sign_btn[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'sign_btn')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Delivery Title</label>
<input type="text" name="delivery_title[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'delivery_title')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Dining Title</label>
<input type="text" name="dinein_title[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'dinein_title')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Location Title</label>
<input type="text" name="location_title[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'location_title')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">View Direction</label>
<input type="text" name="direction[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'direction')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Contact No</label>
<input type="text" name="contact_no[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'contact_no')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Call Now</label>
<input type="text" name="call_now[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'call_now')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Timing</label>
<input type="text" name="timing[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'timing')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Avg Per Person</label>
<input type="text" name="avg_per[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'avg_per')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">View Menu</label>
<input type="text" name="view_menu[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'view_menu')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Access Page</label>
<input type="text" name="access_page[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'access_page')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Pay With Paypal</label>
<input type="text" name="pay_paypal[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'pay_paypal')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Pay With PayStack</label>
<input type="text" name="pay_paystack[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'pay_paystack')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Paypal Payment Faild Message</label>
<input type="text" name="paypal_fail[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'paypal_fail')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Paypal Not Config Message</label>
<input type="text" name="text_paypal_wrong[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'text_paypal_wrong')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Delivery Charge Message</label>
<input type="text" name="d_charge_msg[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'d_charge_msg')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Select Your Location</label>
<input type="text" name="select_location[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'select_location')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Clear</label>
<input type="text" name="clear[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'clear')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Fast Delivery</label>
<input type="text" name="fast_delivery[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'fast_delivery')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Choose From Category</label>
<input type="text" name="choose_category[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'choose_category')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">View All</label>
<input type="text" name="view_all[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'view_all')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Store Around You</label>
<input type="text" name="store_around[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'store_around')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Showing For category</label>
<input type="text" name="showing_category[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'showing_category')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Filter By</label>
<input type="text" name="filter_by[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'filter_by')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Footer Cart</label>
<input type="text" name="footer_cart[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'footer_cart')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Footer Profile</label>
<input type="text" name="footer_profile[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'footer_profile')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Your Profile</label>
<input type="text" name="your_profile[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'your_profile')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Menu Description</label>
<input type="text" name="menu_desc[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'menu_desc')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Continue</label>
<input type="text" name="conti[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'conti')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">View Account</label>
<input type="text" name="view_account[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'view_account')); ?>">
</div>
...
<input type="text" name="all_store_deliver[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'all_store_deliver')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Recent Search Query</label>
<input type="text" name="recent_search_query[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'recent_search_query')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Veg Only</label>
<input type="text" name="veg[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'veg')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Non-Veg Only</label>
<input type="text" name="nonveg[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'nonveg')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Add</label>
<input type="text" name="add[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'add')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Cooking Ins</label>
<input type="text" name="cooking_notes[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'cooking_notes')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Write Notes</label>
<input type="text" name="write_note[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'write_note')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Country</label>
<input type="text" name="country[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'country')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Verify Your Email</label>
<input type="text" name="verify_your_email[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'verify_your_email')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Verify Your Phone</label>
<input type="text" name="verify_your_phone[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'verify_your_phone')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Verify Code has been sent</label>
<input type="text" name="verify_code_sent[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'verify_code_sent')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">i agree with</label>
<input type="text" name="i_agree[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'i_agree')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Terms & Condition</label>
<input type="text" name="terms[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'terms')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Add Tip</label>
<input type="text" name="add_tip[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'add_tip')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Tip Added</label>
<input type="text" name="tip_added[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'tip_added')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Address & Payment Method</label>
<input type="text" name="address_payment[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'address_payment')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Select Delivery Address</label>
<input type="text" name="select_delivery_address[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'select_delivery_address')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">New Address</label>
<input type="text" name="want_new_address[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'want_new_address')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Select Tip Amount</label>
<input type="text" name="select_tip[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'select_tip')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Pay with FlutterWave</label>
<input type="text" name="fw[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'fw')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Start Using</label>
<input type="text" name="start_using[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'start_using')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Use Ecash Description</label>
<input type="text" name="ecash_use_desc[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'ecash_use_desc')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Whatsapp Chat</label>
<input type="text" name="w_chat[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'w_chat')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">View Less</label>
<input type="text" name="view_less[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'view_less')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Get Started</label>
<input type="text" name="get_started[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'get_started')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Email us</label>
<input type="text" name="email_us[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'email_us')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Call Us</label>
<input type="text" name="call_us[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'call_us')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Send Message on Whatsapp</label>
<input type="text" name="send_msg[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'send_msg')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Any Query</label>
<input type="text" name="any_query[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'any_query')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Your Message</label>
<input type="text" name="your_msg[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'your_msg')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Decline</label>
<input type="text" name="decline[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'decline')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">You will earn</label>
<input type="text" name="you_earn[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'you_earn')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Drop-Off</label>
<input type="text" name="drop_off[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'drop_off')); ?>">
</div>
...
<input type="text" name="hotspot[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'hotspot')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Edit</label>
<input type="text" name="edit[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'edit')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Delete</label>
<input type="text" name="delete[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'delete')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Add New</label>
<input type="text" name="add_new[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'add_new')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Select Category</label>
<input type="text" name="select_category[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'select_category')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Item Name</label>
<input type="text" name="item_name[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'item_name')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Description</label>
<input type="text" name="description[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'description')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Item Type</label>
<input type="text" name="item_type[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'item_type')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Both</label>
<input type="text" name="both[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'both')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Sort Order</label>
<input type="text" name="sort_order[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'sort_order')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Upload Image</label>
<input type="text" name="upload_img[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'upload_img')); ?>">
</div>

<div class="form-group col-md-4">
<label for="inputEmail6">New Category Name</label>
<input type="text" name="new_cate_name[]" class="form-control" value="<?php echo e($data->getSData($l['id'],'new_cate_name')); ?>">
</div>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/text/form.blade.php ENDPATH**/ ?>