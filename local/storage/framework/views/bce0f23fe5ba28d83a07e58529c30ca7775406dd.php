...
<td width="12%"><?php echo app('translator')->get('app.store_username'); ?> <?php echo e($row->phone); ?><br><small><?php echo app('translator')->get('app.store_password'); ?> <?php echo e($row->shw_password); ?></small></td>
<td width="10%">
...
<td width="10%">
<?php if($row->delivery == 0): ?> <p>Delivery</p> <?php endif; ?>
<?php if($row->dinein == 0): ?> <p style="color:green">Dinein</p> <?php endif; ?>
</td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/store/index.blade.php ENDPATH**/ ?>