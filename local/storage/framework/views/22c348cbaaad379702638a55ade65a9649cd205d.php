...
<li><a href="<?php echo e(Asset('setting')); ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce"><?php echo app('translator')->get('app.setting'); ?></span></a></li>
<li><a href="<?php echo e(Asset('country')); ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">Manage Country</span></a></li>
</ul>
</li>
...
<li class="<?php if($page == 'welcome'): ?> active <?php endif; ?> nav-item"><a href="<?php echo e(Asset('welcome')); ?>"><i class="fa fa-image"></i><span class="menu-title" data-i18n="Email">Welcome Sliders</span></a></li>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/layout/menu.blade.php ENDPATH**/ ?>