<?php $__env->startSection('title'); ?> Delivery Staff <?php $__env->stopSection(); ?>
...
<div class="card-body"><h4 class="card-title">Delivery Staff <a href="<?php echo e(Asset($link.'add')); ?>" class="btn btn-primary" style="float: right"><?php echo app('translator')->get('app.add_new'); ?></a></h4> </div>
...
<td width="20%"><?php echo e(Auth::user()->currency.$row->charge); ?></td>
<td width="15%">
...
<?php echo $__env->make('store_end.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/saas_pos/local/resources/views/store_end/delivery/index.blade.php ENDPATH**/ ?>