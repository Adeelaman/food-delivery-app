...
<label for="inputEmail6">Country Name</label>
<?php echo Form::text('name',null,['id' => 'code','class' => 'form-control','required']); ?>

</div>

<div class="form-group col-md-4">
<label for="inputEmail6">Country Code (Without +)</label>
<?php echo Form::number('code',null,['id' => 'code','class' => 'form-control','required']); ?>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/country/form.blade.php ENDPATH**/ ?>