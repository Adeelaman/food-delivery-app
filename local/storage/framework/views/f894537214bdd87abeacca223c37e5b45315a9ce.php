...
<td width="15%"><a href="<?php echo e(Asset(env('store').'/getReport?id='.$row->store_id)); ?>" target="_blank" data-toggle="tooltip" data-placement="top" data-original-title="View all orders from <?php echo e($row->store); ?>"><?php echo e($row->store); ?></a>
...
<td width="12%"><?php echo e($row->name); ?><br>
...
<td width="18%"><?php echo e($row->address); ?>
...
<br><small style="color:red">Delivery Date : <?php echo e(date('d-M-Y',strtotime($row->order_date))); ?> | <?php echo e($row->order_time); ?></small>
...
<?php echo $__env->make('store_end.order.button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<br>
</td>
</tr>
...
</table><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/saas_pos/local/resources/views/store_end/order/table.blade.php ENDPATH**/ ?>