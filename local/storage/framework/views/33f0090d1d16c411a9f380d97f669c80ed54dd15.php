...
<div class="form-group col-md-6">
<label for="inputEmail6"><?php echo app('translator')->get('app.phone'); ?></label>
<?php echo Form::number('phone',null,['id' => 'code','class' => 'form-control']); ?>
...
<?php echo Form::number('charge',null,['id' => 'code','class' => 'form-control','step' => '0.1']); ?>

</div>

<div class="form-group col-md-3">
<label for="inputEmail6">Per KM Charge</label>
<?php echo Form::number('per_km',null,['id' => 'code','class' => 'form-control','step' => '0.1']); ?>

</div>

<div class="form-group col-md-6">
<?php if(!$data->id): ?>
<label for="inputEmail6"><?php echo app('translator')->get('app.password'); ?></label>
<input type="password" name="password" class="form-control" required="required">
<?php else: ?>
<label for="inputEmail6"><?php echo app('translator')->get('app.change_password'); ?></label>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pos/local/resources/views/delivery/form.blade.php ENDPATH**/ ?>